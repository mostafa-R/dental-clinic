            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-700">
                  <th scope="col" className="text-start px-4 py-3 font-medium text-slate-500">{t("alertsSeverity", language)}</th>
                  <th scope="col" className="text-start px-4 py-3 font-medium text-slate-500">{t("alertsType", language)}</th>
