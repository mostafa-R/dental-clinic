            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-700">
                  <th scope="col" className="text-start px-4 py-3 font-medium text-slate-500">{t("date", language)}</th>
                  <th scope="col" className="text-start px-4 py-3 font-medium text-slate-500">{t("type", language)}</th>
                  <th scope="col" className="text-start px-4 py-3 font-medium text-slate-500">{t("status", language)}</th>
                  <th scope="col" className="text-start px-4 py-3 font-medium text-slate-500">{t("filename", language)}</th>
                  <th scope="col" className="text-start px-4 py-3 font-medium text-slate-500">{t("size", language)}</th>
                  <th scope="col" className="text-start px-4 py-3 font-medium text-slate-500">{t("duration", language)}</th>
                </tr>
              </thead>
              <tbody>
                {items.map((backup) => (
