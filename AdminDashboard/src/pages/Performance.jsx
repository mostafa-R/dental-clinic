                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-slate-700">
                      <th scope="col" className="text-start px-4 py-3 font-medium text-slate-500">{t("route", language)}</th>
                      <th scope="col" className="text-end px-4 py-3 font-medium text-slate-500">{t("hits", language)}</th>
                      <th scope="col" className="text-end px-4 py-3 font-medium text-slate-500">{t("avgMs", language)}</th>
                      <th scope="col" className="text-end px-4 py-3 font-medium text-slate-500">{t("minMs", language)}</th>
                      <th scope="col" className="text-end px-4 py-3 font-medium text-slate-500">{t("maxMs", language)}</th>
                      <th scope="col" className="text-end px-4 py-3 font-medium text-slate-500">{t("errors", language)}</th>
                      <th scope="col" className="text-end px-4 py-3 font-medium text-slate-500">{t("errorRateLabel", language)}</th>
                    </tr>
                  </thead>
                  <tbody>
                    {routes.map((route) => (
