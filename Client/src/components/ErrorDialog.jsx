  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div
        ...
        aria-describedby={message ? 'error-dialog-message' : undefined}
        className="relative z-10 w-full max-w-md rounded-xl bg-white p-6 shadow-xl outline-none dark:bg-slate-900"
      >
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p id="error-dialog-message" className="mt-1 text-sm text-slate-600 dark:text-slate-300">{message}</p>
          </div>
        </div>
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            onClick={onClose}
            autoFocus
            className="rounded-lg bg-brand px-4 py-2 text-sm font-medium text-white transition hover:bg-brand-dark focus:outline-none focus:ring-2 focus:ring-brand/40 dark:bg-brand dark:hover:bg-brand-dark"
          >
            {t('common.gotIt')}
          </button>
        </div>
