          ...
          <div className="mt-2 flex flex-wrap gap-1" onClick={(e) => e.stopPropagation()}>
            {options.map((opt) => (
              <button
                ...
                className="min-h-[32px] rounded-md border border-slate-200 px-2.5 py-1 text-xs font-medium text-slate-500 transition hover:bg-brand/5 hover:text-brand-dark active:bg-brand/10 disabled:opacity-50 dark:border-slate-600 dark:text-slate-400 dark:hover:bg-slate-700"
              >
        ...
        <div className="mt-2 flex flex-wrap gap-1.5" onClick={(e) => e.stopPropagation()}>
          {options.map((opt) => (
            <button
              ...
              onClick={() => handleTransition(opt)}
              disabled={transitioning}
              className="rounded-md border border-slate-200 px-2 py-0.5 text-[11px] font-medium text-slate-500 transition hover:bg-brand/5 hover:text-brand-dark disabled:opacity-50 dark:border-slate-600 dark:text-slate-400 dark:hover:bg-slate-700"
            >
              <span className="rtl:-scale-x-100 inline-block">→</span> {t(statusTKey(opt))}
            </button>
          ))}
