      ...
      <form id="invoice-form" onSubmit={onSubmit} className="space-y-5">
        ...
        <div>
          <div className="mb-2 flex items-center justify-between">
            ...
            <button type="button" onClick={addItem} className="text-xs font-medium text-brand hover:text-brand-dark dark:text-brand-light">
            ...
            {form.items.map((it, i) => (
              <div key={i} className="grid grid-cols-12 gap-2">
                <input
                  ...
                  className="col-span-12 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-brand focus:ring-2 focus:ring-brand/20 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500 sm:col-span-6"
                />
                <input
                  type="number"
                  min="1"
                  ...
                  className="col-span-4 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-brand focus:ring-2 focus:ring-brand/20 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 sm:col-span-2"
                />
                <input
                  type="number"
                  min="0"
                  ...
                  className="col-span-8 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-brand focus:ring-2 focus:ring-brand/20 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500 sm:col-span-3"
                />
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="grid grid-cols-2 gap-4">
            <div className="block">
              ...
              <div className="flex gap-2">
                <select value={form.discountType} onChange={(e) => setForm((f) => ({ ...f, discountType: e.target.value }))} className="w-28 rounded-lg border border-slate-300 bg-white px-2 py-2 text-sm text-slate-900 outline-none focus:border-brand dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm dark:border-slate-700 dark:bg-slate-800/50">
            ...
            <div className="mt-2 flex items-center justify-between border-t border-slate-200 pt-2 dark:border-slate-700">
              ...
              <span className="text-lg font-semibold text-brand-dark dark:text-brand-light">{formatMoney(totals.total)}</span>
            </div>
          </div>
        </div>
