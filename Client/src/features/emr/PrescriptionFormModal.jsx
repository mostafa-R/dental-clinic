      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="mb-2 flex items-center justify-between">
            ...
            <button type="button" onClick={addMed} className="rounded-md bg-brand/5 px-2 py-1 text-xs font-medium text-brand transition hover:bg-brand/10 dark:bg-brand/20 dark:text-brand-light">
              {t('emr.rx.addMed')}
            </button>
          </div>
