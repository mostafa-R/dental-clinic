      ...
      footer={
        <>
          ...
          <button
            ...
            className="rounded-lg bg-brand px-4 py-2 text-sm font-medium text-white transition hover:bg-brand-dark disabled:opacity-50 dark:bg-brand dark:hover:bg-brand-dark"
          >
      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="mb-2 flex items-center justify-between">
            ...
            <button type="button" onClick={addItem} className="rounded-md bg-brand/5 px-2 py-1 text-xs font-medium text-brand transition hover:bg-brand/10 dark:bg-brand/20 dark:text-brand-light">
              {t('emr.plan.addItem')}
            </button>
          </div>
