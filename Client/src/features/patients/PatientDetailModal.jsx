      ...
      {!patient ? (
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-brand/5 text-xl font-semibold text-brand dark:bg-brand/20 dark:text-brand-light">
