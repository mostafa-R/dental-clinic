...
export default function WhatsAppSettings() {
  ...
  const inputCls =
    'w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:ring-2 focus:ring-brand/40 dark:border-slate-600 dark:bg-slate-800 dark:text-white';
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-24 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:ring-2 focus:ring-brand/40 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
            />
          </div>
        </div>
      </Card>
