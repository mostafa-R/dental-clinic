...
const PLAN_STATUS_STYLES = {
  active: 'bg-brand/10 text-brand-dark dark:bg-brand-dark/40 dark:text-brand-light',
          ...
          <form onSubmit={handleCreatePlan} className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <button type="button" onClick={handleAddInstallment}
                className="text-xs font-medium text-brand hover:text-brand-dark dark:text-brand-light">
