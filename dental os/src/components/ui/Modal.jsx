    ...
    return (
      <div className="fixed inset-0 z-50 flex flex-col sm:items-center sm:justify-center sm:overflow-y-auto sm:p-6">
        <div
          ...
          aria-hidden="true"
        />
        <div className="relative z-10 flex h-full flex-col bg-white sm:my-8 sm:h-auto sm:w-full sm:max-w-4xl sm:rounded-2xl sm:shadow-xl dark:bg-slate-900">
          <div className="flex shrink-0 items-center justify-between border-b border-slate-100 px-4 py-3 sm:px-5 sm:py-4 dark:border-slate-800">
