...
export default function Recalls() {
  ...
  const selectCls = 'rounded-lg border border-slate-200 bg-white px-2 py-1.5 text-sm text-slate-700 outline-none focus:border-indigo-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <input
          ...
          className="min-w-52 flex-1 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm outline-none focus:border-indigo-500 dark:border-slate-700 dark:bg-slate-800 dark:text-white sm:max-w-xs"
        />
