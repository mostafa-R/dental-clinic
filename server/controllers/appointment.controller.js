...
import Appointment, { canTransition } from '../models/Appointment.js';
...
async function assertReferences(payload) {
  ...
  if (!patient) throw ApiError.badRequest('Referenced patient does not exist', { patient: 'not found' });
...
export const createAppointment = asyncHandler(async (req, res) => {
  ...
  await assertReferences({ patient: data.patient, doctor: data.doctor });
