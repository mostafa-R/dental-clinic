...
router.get('/', protect, checkPermission('patients', 'read'), validate(listPatientsQuerySchema, 'query'), listPatients);
router.get('/:id', protect, checkPermission('patients', 'read'), getPatient);
