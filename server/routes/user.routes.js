...
import { createUser, deleteUser, getUser, listDoctors, listUsers, toggleUserActive, updateUser } from '../controllers/user.controller.js';
...
router.get('/', protect, checkPermission('users', 'read'), listUsers);
