...
import { getSettings, updateSettings, connect, getQrCode, disconnect, status, testMessage } from '../controllers/whatsapp.controller.js';

const whatsappSettingsSchema = z.object({
  provider: z.enum(['whatsapp_web', 'twilio', 'message_bird']).optional(),
